...
namespace Rocket.Unturned
{
    public class U : MonoBehaviour, IRocketImplementation, IModuleNexus
    {
        ...
        private static readonly TranslationList DefaultTranslations = new TranslationList
        {
            ...
            { "command_god_enable_console", "{0} enabled god mode." },
            { "command_god_enable_private", "You can feel the strength now..." },
            { "command_god_disable_console", "{0} disabled god mode." },
            { "command_god_disable_private", "The godly powers left you..." },
            { "command_vanish_enable_console", "{0} enabled vanish mode." },
            { "command_vanish_enable_private", "You are vanished now..." },
            { "command_vanish_disable_console", "{0} disabled vanish mode." },
            ...
            { "command_investigate_private", "{0}'s SteamID64 is {1}" },
        ...
        internal void Initialize()
        {
            try
            {
                ...
                Translation = new XMLFileAsset<TranslationList>(string.Format(Environment.TranslationFile, R.Settings.Instance.LanguageCode), new[]{ typeof(TranslationList), typeof(TranslationListEntry) }, DefaultTranslations);
                ...
                try
                {
                    R.Plugins.OnPluginsLoaded += () => SteamGameServer.SetKeyValue("rocketplugins", string.Join(",", R.Plugins.GetPlugins().Select(p => p.Name)));
        ...
        public static string Translate(string translationKey, params object[] placeholder) => Translation.Instance.Translate(translationKey, placeholder);
